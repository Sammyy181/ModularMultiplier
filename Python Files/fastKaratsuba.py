...
def findParts(X: int, Y: int):
    ...
    Z8_1 = extract_bitsM8(hexX, 10, 8) * extract_bitsM8(hexY, 3, 0)
    Z9 = extract_bitsM8(hexX, 8, 6) * extract_bitsM8(hexY, 6, 3)
    Z9_1 = extract_bitsM8(hexX, 2, 0) * extract_bitsM8(hexY, 12, 9)
    Z10 = extract_bitsM8(hexX, 6, 4) * extract_bitsM8(hexY, 9, 6)
    Z10_1 = extract_bitsM8(hexX, 12, 10) * extract_bitsM8(hexY, 3, 0)
    ...
    Z20_1 = extract_bitsM8(hexX, 16, 14) * extract_bitsM8(hexY, 9, 6)
    ...
    Z22_1 = extract_bitsM8(hexX, 18, 16) * extract_bitsM8(hexY, 9, 6)
    ...
    Z38_1 = extract_bitsM8(hexX, 16, 14) * extract_bitsM8(hexY, 27, 24)
    Z39 = extract_bitsM8(hexX, 20, 18) * extract_bitsM8(hexY, 24, 21)
    Z39_1 = extract_bitsM8(hexX, 26, 24) * extract_bitsM8(hexY, 18, 15)
    Z40 = extract_bitsM8(hexX, 24, 22) * extract_bitsM8(hexY, 21, 18)
    Z40_1 = extract_bitsM8(hexX, 18, 16) * extract_bitsM8(hexY, 27, 24)
    ...
    Z50_1 = extract_bitsM8(hexX, 22, 20) * extract_bitsM8(hexY, 32, 30)
    Z51 = extract_bitsM8(hexX, 26, 24) * extract_bitsM8(hexY, 30, 27)
    Z51_1 = extract_bitsM8(hexX, 32, 30) * extract_bitsM8(hexY, 24, 21)
    Z52 = extract_bitsM8(hexX, 30, 28) * extract_bitsM8(hexY, 27, 24)
    Z52_1 = extract_bitsM8(hexX, 24, 22) * extract_bitsM8(hexY, 32, 30)
    ...
    S106_48 = M6 + Z0 + Z12 + (Z7 * pow(2, 8)) + ((Z8 + Z8_1) * pow(2, 16))
    S122_72 = Z9 + Z9_1 + ((Z10 + Z10_1) * pow(2, 8))
    ...
    S203_160 = Z20 + Z20_1 + M20_2 + Z2 + Z38
    S211_168 = Z21 + Z21_1 + M21_2 + Z3 + Z39
    S219_176 = Z22 + Z22_1 + M22_2 + Z4 + Z40
    ...
    S347_304 = Z38 + Z38_1 + M38_2 + Z20 + Z56
    S355_312 = Z39 + Z39_1 + M39_2 + Z21 + Z57
    S363_320 = Z40 + Z40_1 + M40_2 + Z22 + Z58
    ...
    S450_400 = Z50 + Z50_1 + ((Z51 + Z51_1) * pow(2, 8))
    S465_416 = Z52 + Z52_1 + (Z53 * pow(2, 8))
